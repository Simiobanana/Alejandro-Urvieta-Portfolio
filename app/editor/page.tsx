...
import { isPortfolioOwner } from "../../lib/editor-auth";
...
export default async function EditorPage(){
  ...
  if(!isPortfolioOwner(user.userId))return <main className="editor-shell"><section className="editor-auth glass"><p className="kicker">ACCESO RESTRINGIDO</p><h1>Esta cuenta no puede editar.</h1><p>La sesión corresponde a {user.email}.</p><a className="button ghost" href={chatGPTSignOutPath("/editor")}>Cambiar de cuenta</a></section></main>;
