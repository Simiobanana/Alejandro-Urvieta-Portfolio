 ...
 return <main className="realm-study" lang="es" data-night={night} data-motion={motion} data-world={view}>
  ...
  <div className="study-layout">
   ...
   <section className="study-stage" aria-label="Vista de la composición">
    ...
    <Scene className="study-canvas" label="Yggdrasil 3D. Usa los botones para explorar los tres reinos." view={view} night={night} motion={motion} pose={pose} onStatus={setStatus}/>
